...
namespace Queuing_System_Alipour.Window
{
    public partial class FrmAddAtelierQueue : Form
    {
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            newQueue.FullName = txtbox_fullname.Text;
            newQueue.PhoneNumber = txtbox_phonenumber.Text;
            newQueue.QueueCreatedAt = txtbox_date.Value.HasValue ? txtbox_date.Value.Value.AddHours(int.Parse(txtbox_startHour.Text.Substring(0, 2))) : null;
            newQueue.QueueDuration = string.IsNullOrWhiteSpace(combobox_duration.Text) ? null : int.Parse(combobox_duration.Text);
            newQueue.EmployeeId = AppState.EmployeeId;
            newQueue.Note = note;
            ...
            //    QueueCreatedAt = txtbox_date.Value.HasValue ? txtbox_date.Value.Value : null,
            //    QueueDuration = TimeSpan.FromHours(int.Parse(combobox_duration.Text)),
